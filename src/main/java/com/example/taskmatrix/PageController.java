...
public class PageController {
    ...
    public String getIndexPage(
        ...
        List<Task> tasks = taskService.getAllTasks(label, dueDateBefore, dueDateAfter, importance, urgency, quadrant, sortBy, sortDir);
        ...
        model.addAttribute("currentQuadrant", quadrant);
        ...
        model.addAttribute("quadrantValues", Quadrant.values());
        // For sortBy, we can define a list of valid fields, or get them from Task entity (more complex)
